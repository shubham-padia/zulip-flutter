...
class InboxCollapsedChannels extends Table
    with TableInfo<InboxCollapsedChannels, InboxCollapsedChannelsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  InboxCollapsedChannels(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> accountId = GeneratedColumn<int>(
    'account_id',
    aliasedName,
    false,
  ...
  @override
  InboxCollapsedChannelsData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return InboxCollapsedChannelsData(
      accountId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}account_id'],
      )!,
  ...
  @override
  InboxCollapsedChannels createAlias(String alias) {
    return InboxCollapsedChannels(attachedDatabase, alias);
  }
...
class InboxCollapsedChannelsData extends DataClass
    implements Insertable<InboxCollapsedChannelsData> {
  final int accountId;
  final int channelId;
  const InboxCollapsedChannelsData({
    required this.accountId,
  ...
  factory InboxCollapsedChannelsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  InboxCollapsedChannelsData copyWith({int? accountId, int? channelId}) =>
      InboxCollapsedChannelsData(
        accountId: accountId ?? this.accountId,
        channelId: channelId ?? this.channelId,
      );
  InboxCollapsedChannelsData copyWithCompanion(
  ...
  @override
  String toString() {
    return (StringBuffer('InboxCollapsedChannelsData(')
          ..write('accountId: $accountId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is InboxCollapsedChannelsData &&
          other.accountId == this.accountId &&
          other.channelId == this.channelId);
}

class InboxCollapsedChannelsCompanion
    extends UpdateCompanion<InboxCollapsedChannelsData> {
  final Value<int> accountId;
  ...
  InboxCollapsedChannelsCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       channelId = Value(channelId);
  static Insertable<InboxCollapsedChannelsData> custom({
    Expression<int>? accountId,
...
class DatabaseAtV17 extends GeneratedDatabase {
  ...
  late final InboxCollapsedChannels inboxCollapsedChannels =
      InboxCollapsedChannels(this);
  @override
